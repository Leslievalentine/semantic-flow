...
import { BookOpen, Plus, MoreHorizontal, Sparkles, Upload, Merge, PanelLeftClose, PanelLeft, Trash2, Pencil, GripVertical, LogOut, User as UserIcon, Brain } from 'lucide-react'
        ...
        <aside className="w-72 h-screen bg-sidebar text-sidebar-foreground flex flex-col border-r border-sidebar-border flex-shrink-0">
            ...
            <div className="px-5 py-3 border-b border-sidebar-border space-y-3">
                ...
                <button
                    ...
                    "
                >
                    <Brain className="w-5 h-5 text-amber-600 group-hover:scale-110 transition-transform" />
                    <div className="text-left">
                        <span className="text-sm font-semibold text-amber-800">Knowledge Vault</span>
                        <p className="text-xs text-amber-600/70">Review your mastery</p>
                    </div>
                </button>
            </div>
